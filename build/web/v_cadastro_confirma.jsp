...
if(request.getParameter("data_pes")!=null){
	...
	if((dia >29) && mes==2){
		validacao = 1;
		out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=2';</script>");
	}else if(dia >31 && (mes==1 ||mes==3 ||mes==5 ||mes==7 || mes==8 ||mes==10 ||mes==12)){
		validacao = 1;
                out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=3';</script>");
	}else if(dia >30 && (mes==4 || mes==6 || mes==9 ||mes==11)){
		validacao = 1;
		out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=4';</script>");
	}else if(mes>12){
		validacao = 1;
                out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=5';</script>");
	}
...
if(request.getParameter("cpf_pes")!=null){
	...
	if(retorno != 0){
	validacao = 1;
	out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=1';</script>");
	}
}
...
m_objpes = new Model.M_pessoa(0,nome_pes,cpf_pes,data_pes,peso_pes,uf_pes);
...
out.print("<script>window.location.href = 'index.jsp?ret=1&msg=1';</script>");
}else{
out.print("<script>window.location.href = 'v_cadastro_novo.jsp?ret=1&msg=6';</script>");
}
%>
